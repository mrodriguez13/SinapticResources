    ...
    $pnp.sp.site.rootWeb.lists.getByTitle("AccesosDocumentos").items.get().then(r => {
        ...
        $.each(r, function (index, value) {
            ...
            if (value.Subsitio == window.location.href) {
                var documento = '<div id="' + documentos + '" app-access"><img src="' + value.Icono.Url + '"; width=35px;/><a href="' + value.Documento + '"><span class="visible-xs-inline" style="margin-left: 12px">' + value.Title + '</span></a></div>';
