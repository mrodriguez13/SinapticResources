    ...
    var getSiniestrosData = function (data) {
        ...
        $(resData).each(function (i, item) {
            ...
            if (item["SiniestroCancelado"]) {
                ...
                tasksStructure.push("<button type='button' class='btn btn-primary btn-xs restoreSinister' title='Restaurar siniestro cancelado'><i class='glyphicon glyphicon-share'></i></button>");
                ...
                tasksStructure.push("<button data-idsinister= '" + idSiniestro + "' type='button' class='btn btn-primary btn-xs delButton' title='Eliminar siniestro' onclick='sinaptic.adminTasks.modalAskDelete(this.dataset.idsinister);'><i class='glyphicon glyphicon-trash'></i></button>");
